...
/**
 * File Name: Assign2.java Student Name: Aman Multani Course Name: Data
 * Structure Lab Section: Date: Purpose: The class is the driver class for
 * Assignment 2 Description: This class contains the main method and displays
 * the menu.
 */
public class Assign2 {
	...
	public void menu() {
		...
		while (!done) {
			...
			System.out.print("Enter Option form the menu : ");
			String option = null;
	...
	/**
	 * Prompts user to enter the name of the EmailList and adds an EmailAddress
	 * to the list.
	 */
	...
	/**
	 * Prompts user to enter a name that represents the EmailList and returns
	 * the name.
	 *
	 * @return String
	 */
